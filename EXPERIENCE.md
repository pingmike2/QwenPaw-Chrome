...
认证链经常断，且公网 20208 只要链接泄露就等于把浏览器桌面裸奔给别人。

**结论**：**Xvnc 的 VncAuth（VNC 协议密码）是最轻量、最可靠的方案** ——
不需要额外后端，noVNC 原生弹密码框，端口 20208/30209/30210 共用同一个密码。
...
| 本地端口 | 用途 | 公网端口 | 说明 |
|---------|------|---------|------|
| `8080` (VNC_PORT) | Caddy noVNC 入口 | `20208` | Caddy `reverse_proxy 127.0.0.1:18080` |
